  ...
  return (
    <>
      <Head>
        ...
        <meta
          name={'keywords'}
          content={'web development, social app, programming'}
        />
      </Head>
      <Header />
      <main className={'grid grid-cols-12'}>
        <section className={'col-span-3 pl-2'}>
          <h1
            className={'text-left pt-3 mb-3 text-xl capitalize text-gray-400'}
          >
            Profile
          </h1>
          <p>
          ...
          <a className={styles.button} href='/edit-account'>
            Edit page
          </a>
        </section>
        ...
        <section className={' col-span-3'}>
          <h1
            className={'text-left pt-3 pl-4 text-xl capitalize text-gray-400'}
          >
            contacts
          </h1>
          <ul>
